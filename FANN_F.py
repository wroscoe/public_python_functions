...
def convert_bpnn_array_to_fann_file(arr = [[[1,2], [5]], [[4,4],[3]]] ):
    """ accept an array in the training data format of bpnn.py  and return a string in the FANN training data format """
...
def convert_fann_file_to_bpnn_array(str = '2 2 1\n1 2\n5\n4 4\n3\n'):
    """ a string in the format of the FANN training data to an array formated for bpnn.py to """
    arrLines = str.split('\n')
